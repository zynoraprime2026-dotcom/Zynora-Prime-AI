...
const WHATSAPP_FEEDBACK_NUMBER = "233541821537";
...
async function fetchCloudConversations(session) {
...
async function fetchCloudMessages(session, conversationId) {
...
async function cloudUpsertConversation(session, conv) {
...
async function cloudSyncMessages(session, conversationId, messages) {
...
async function cloudDeleteConversation(session, id) {
...
async function streamClaudeAPI(history, profileName, dataSaver, replyLanguage, onDelta) {
  ...
  onDelta(data.text || "I didn't catch that — could you rephrase?");
}
...
// ---------- Message bubble ----------
function MessageBubble({ styles, role, content, streaming, attachmentName, isImage, imageData, imageMimeType, onRegenerate, onEdit, disabled, dataSaver }) {
